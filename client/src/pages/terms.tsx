        ...
        <Card>
          <CardContent className="p-5 sm:p-8 space-y-6 text-sm leading-relaxed">
            ...
            <section className="space-y-2">
              ...
              <p>
                Each plan includes specific usage limits for lead discoveries and saved leads. Free plan users are limited to 5 discoveries per month and 25 saved leads. Pro plan users receive 50 discoveries per month and unlimited saved leads.
              </p>
              <p>
