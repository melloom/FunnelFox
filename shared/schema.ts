...
export const insertLeadSchema = z.object({
  ...
  websiteUrl: z.string().max(500).refine((url) => {
    // Allow empty string
    ...
    message: "Please enter a valid URL (e.g., facebook.com/joes-pizza, www.joespizza.com, or https://joespizza.com) or leave empty"
  }),
